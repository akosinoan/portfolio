        ...
        <section className="bg-gray-200 scroll-mt-20" id="about">
            ...
            <div className=" flex flex-col mx-10  py-16 md:py-20 lg:flex-row items-center lg:justify-center ">
                <div className=" lg:w-[40%] text-center  lg:text-left">
                    ...
                    <div ref={ref1} className={ " ease-in-out transition-all duration-700 delay-300 relative" +
                            (isVisible1 ? " left-[0%] opacity-100" : "  -left-[50%] opacity-0") }>
                    ...
                    <div ref={ref2} className={ " ease-in-out transition-all duration-500 delay-150  relative" +
                            (isVisible2 ? " left-[0%] opacity-100" : "  -left-[50%] opacity-0") }>
                ...
                <div className=" pl-0 pt-10 w-[50%] lg:w-[20%] lg:pl-12 lg:pt-0">
                    <div ref={ref3} className={ " ease-in-out transition-all duration-500 delay-150  relative" +
                            (isVisible3 ? " left-[0%] opacity-100" : "  left-[50%] opacity-0") }>
