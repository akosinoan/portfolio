        ...
        <header id="home" >
            ...
            <div className="mt-16 bg-red-950 bg-opacity-80 relative">
                <div className="absolute h-full w-full -z-50">
                        <ImageWithLoader src={yosemiteBg} alt="yosemite-background" wrapperClassName="h-full w-full" className="h-full w-full object-cover" spinnerClassName="h-10 w-10 border-2" />
                ...
                <div className=" relative z-30 pt-20 pb-12 sm:pt-56 sm:pb-48 lg:pt-64 lg:pb-48">
                    <div className="flex flex-col items-center justify-center lg:flex-row">
                        ...
                        <ImageWithLoader src={profPic} alt="author" wrapperClassName="h-32 w-32 sm:h-48 sm:w-48 rounded-full" className="h-full w-full object-cover rounded-full" spinnerClassName="h-7 w-7 border-2" />
                        </div>
